                ...
                <template x-for="(content, index) in contents" :key="index">
                    <div class="grid grid-cols-1 gap-3 mb-3 w-full text-black">
                        <div>
                            ...
                            <input type="text" x-model="content.title" class="w-96 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <div class="h-1">
                        ...
                        <div class="ml-3">
                            <label for="video_description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Description</label>
